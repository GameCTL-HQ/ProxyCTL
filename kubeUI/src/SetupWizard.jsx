...
// Wizard step order — index into WIZ_STEPS is the current screen.
// 0=welcome 1=target 2=prep 3=lockdown 4=cf 5=done
const STEPS = ['welcome', 'target', 'prep', 'lockdown', 'cf', 'tunnel', 'done']
...
export default function SetupWizard({ onFinish, onSignOut }) {
  ...
  // Refresh CF / Tunnel state when we land on the matching step.
    ...
    <div id="setupWiz" className="setupwiz on">
      ...
      <div className="panel">
        <div className="crumbs">
          {[['target','Connect'],['prep','Prepare'],['lockdown','Lock down'],['cf','Cloudflare'],['tunnel','Web Tunnel']].map(([k, lab], i) => {
