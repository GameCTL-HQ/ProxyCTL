        ...
        <div className="body">
          ...
          {cur === 'keys' && (
            <div className="step on">
              ...
              <p className="lede">Each tunnel ProxyCTL creates self-generates a <strong>WireGuard keypair</strong> (a private + public key) that's persisted on the NFS SSD so the tunnel survives restarts. Choose the folder those keypairs live under — keeping them together under one folder avoids cluttering the share root. The default is fine for most setups.</p>
              <label>Keys folder (under the NFS SSD)</label>
              ...
              {keysCfg && (
                <p className="hint" style={{ marginTop: 8 }}>
                  Saves to <span className="mono">/mnt/1TBSSD/{keysVal.trim() || keysCfg.defaultBasePath}</span>
