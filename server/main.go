...
func main() {
	...
	api := &API{store: store, domains: domains, keys: keysStore, webroutes: webroutes, alerts: alertsStore, cf: cf, kube: kube, infra: DefaultInfra(), applier: applier,
...
type API struct {
	...
	alerts      *AlertConfigStore // Discord webhook config for reachability alerts
